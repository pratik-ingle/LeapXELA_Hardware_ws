...
#include "xela_sparshskin_sim/msg/detail/hand_sensors__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const xela_sparshskin_sim::msg::Texel &,
...
cdr_serialize(
  const xela_sparshskin_sim::msg::HandSensors & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: texels
  {
    ...
    for (size_t i = 0; i < size; i++) {
      xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xela_sparshskin_sim::msg::HandSensors & ros_message)
{
  // Member: texels
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: texels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: texels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::max_serialized_size_Texel(
  ...
  if (is_plain) {
    ...
    using DataType = xela_sparshskin_sim::msg::HandSensors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xela_sparshskin_sim::msg::HandSensors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xela_sparshskin_sim::msg::HandSensors *>(
    untyped_ros_message);
...
{
  return &xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::_HandSensors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xela_sparshskin_sim, msg, HandSensors)() {
  return &xela_sparshskin_sim::msg::typesupport_fastrtps_cpp::_HandSensors__handle;
}
