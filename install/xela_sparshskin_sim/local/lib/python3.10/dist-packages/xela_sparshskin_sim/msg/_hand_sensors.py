    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'xela_sparshskin_sim.msg.HandSensors')
            logger.debug(
            ...
            from xela_sparshskin_sim.msg import Texel
...
class HandSensors(metaclass=Metaclass_HandSensors):
    ...
    _fields_and_field_types = {
        'texels': 'sequence<xela_sparshskin_sim/Texel>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['xela_sparshskin_sim', 'msg'], 'Texel')),  # noqa: E501
    )
